package es.joseljg.ejemplo1mysql2324.utilidades;

import static es.joseljg.ejemplo1mysql2324.utilidades.ImagenesBlobBitmap.bytes_to_bitmap;
    ...
    public static void descargarFoto(String nombre_carpeta, String nombre, ImageView imagendescargada) {
        ...
        islandRef.getBytes(tam_foto).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            public void onSuccess(byte[] bytes) {
                ...
                Bitmap imagenbitmapdescargada = bytes_to_bitmap(bytes, ConfiguracionDB.ancho_imagen,ConfiguracionDB.alto_imagen);
